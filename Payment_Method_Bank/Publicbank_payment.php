...
<body>    
    <div class="payment-container">
        <img src="Public_Bank_Logo.png" alt="<?= htmlspecialchars($bankName ?? 'Public Bank') ?> Logo" style="display: block; width: 300px; max-width: 100%; height: auto; object-fit: contain; margin: 1rem auto 1.5rem auto;">
        ...
        <?php elseif (!empty($success_message)): ?>
            ...
            <form method="post">
                <div class="input-group">
                    ...
                    <input type="text" id="account_number" name="account_number" placeholder="e.g., 1234567890" required minlength="10" maxlength="10" pattern="\d{10}" title="Please enter a 10-digit for Publicbank account number.">
                </div>
                <div class="input-group">
