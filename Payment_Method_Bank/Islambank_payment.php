...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_payment']) && empty($error)) 
{
    ...
    elseif (strlen($account_number) != 14) 
    {
        $error = "Bank Islam account number must be 14 digits.";
    }
...
<head>
    ...
    {
        background: #00823f; 
        box-shadow: 0 6px 15px rgba(0, 130, 63, 0.4);
...
<body>    
    <div class="payment-container">
        <img src="Islam_Bank_Logo.png" alt="<?= htmlspecialchars($bankName ?? 'Bank Islam') ?> Logo" style="display: block; width: 320px; max-width: 100%; height: auto; object-fit: contain; margin: 1rem auto 1.5rem auto;">
        ...
        <?php elseif (!empty($success_message)): ?>
            ...
            <form method="post">
                <div class="input-group">
                    ...
                    <input type="text" id="account_number" name="account_number" placeholder="e.g., 1234567890" required minlength="14" maxlength="14" pattern="\d{14}" title="Please enter a 14-digit Bank Islam account number.">
                </div>
                <div class="input-group">
