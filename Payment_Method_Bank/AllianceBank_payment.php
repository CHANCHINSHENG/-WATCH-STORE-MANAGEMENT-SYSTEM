...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirm_payment']) && empty($error)) 
{
    ...
    elseif (strlen($account_number) != 12) {
        $error = "Alliance Bank account number must be 12 digits.";
    }
...
<body>
    <div class="payment-container">
        <img src="Allianc_Bank_Logo.jpeg" alt="<?= htmlspecialchars($bankName ?? 'Bank') ?> Logo" style="display: block; max-width: 280px; max-height: 90px; width: auto; height: auto; object-fit: contain; margin: 1rem auto 1.5rem auto;">
        ...
        <?php elseif (!empty($success_message)): ?>
            ...
            <form method="post">
                <div class="input-group">
                    ...
                    <input type="text" id="account_number" name="account_number" placeholder="e.g., 1234567890" required minlength="12" maxlength="12" pattern="\d{12}" title="Please enter a 12-digit Alliance Bank account number.">
                </div>
                <div class="input-group">
