...
$allowed_pages = [
    ...
    'admin_edit_product', 'admin_edit_customer', 'admin_view_cusorder', 'admin_viewbrand', 'admin_edit_profile','admin_add_brand','admin_view_category','admin_add_category','admin_view_allorder','admin_view_receipt'
];
...
<div class="dashboard">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <a href="admin_layout.php?page=admin_staff" class="nav-item"><i data-lucide="users"></i><span>Staff</span></a>
    ...
    <main class="main-content">
        ...
        <header class="top-header">
            ...
            <div class="header-actions">
                <button class="notifications"><i data-lucide="bell"></i></button>
